...
(function (global, factory) {
  ...
  var distanceMethodMap = (_distanceMethodMap = {}, babelHelpers.defineProperty(_distanceMethodMap, AlgorithmTypes.CIEDE2000, "ciede2kDistance"), babelHelpers.defineProperty(_distanceMethodMap, AlgorithmTypes.HSV, "hsvDistance"), babelHelpers.defineProperty(_distanceMethodMap, AlgorithmTypes.RGB, "rgbDistance"), _distanceMethodMap);
  ...
  var Color = function () {
    babelHelpers.createClass(Color, null, [{
      ...
      value: function ciede2kDistance(color1, color2) {
        ...
        return Color._ciede2kDistance(l1, a1, b1, l2, a2, b2);
      }
    }, {
      key: "_ciede2kDistance",
      value: function _ciede2kDistance(l1, a1, b1, l2, a2, b2) {
        var kl = 1;
        var kc = 1;
        var kh = 1;
        ...
        var c2 = hypot(a2, b2);
        var ac1c2 = (c1 + c2) / 2;
        var g = 0.5 * (1 - sqrt(pow7(ac1c2) / (pow7(ac1c2) + pow7(25))));
        ...
        var rc = sqrt(pow7(acp) / (pow7(acp) + pow7(25)));
  ...
  var ColorClassifier = function () {
    ...
    babelHelpers.createClass(ColorClassifier, [{
      ...
      value: function setPalette(palette) {
        ...
        this.palette = palette.map(function (baseColor) {
